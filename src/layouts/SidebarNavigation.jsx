...
import {RepositoryBrowser, GlobalSearchReplace} from "../components/features/index.js";
...
const SidebarNavigation = ({ isMobile = false }) => {
    ...
    const sidebarContent = useMemo(() => (
        <>
            <RepositoryBrowser />
            <GlobalSearchReplace />
            <nav className="flex mt-6 w-full border-t border-gray-200 pt-4" aria-label="Progress">
